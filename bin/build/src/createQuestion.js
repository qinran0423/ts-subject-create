        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, common_1.setName)(1 /* InputType.QUESTION */)];
                case 1:
                    result = _a.sent();
                    name = result.name;
                    _a.label = 2;
                case 2:
                    ...
                    return [4 /*yield*/, (0, node_fs_1.readdirSync)("".concat((0, createProject_1.getRootPath)(), "/type-challenges"))
                        // 先看看有没有重复创建的
                    ];
                case 3:
                    dirs = _a.sent();
                    ...
                    if (!(hasCreate > -1)) return [3 /*break*/, 5];
